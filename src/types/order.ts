...
export type ColorTintaPapeleria = 'Negro' | 'Azul' | 'Otro';
export type TipoArtePapeleria = 'Solo Impresión' | 'Hacer Arte Nuevo' | 'Modificar Arte Existente';
...
export type FormaPago = 'Contado' | 'Crédito' | 'Sin Factura' | 'Efectivo' | 'Tarjeta' | 'Transferencia';
...
export interface Order {
  ...
  muestra?: boolean;
  colorTinta?: ColorTintaPapeleria;
  colorTintaOtro?: string;
  tipoArte?: TipoArtePapeleria;
  numeradoPor?: string;
  empacadoPor?: string;
  coleccionadoPor?: string;
  refiladoPor?: string;
}

...
const VALID_USERS: { username: string; password: string; user: AuthUser }[] = [
  ...
  {
    username: 'arte1',
    password: 'Hid@s0l-Arte1-2025',
    user: {
      id: 'arte1-001',
      email: 'arte1@hidasol.com',
      name: 'Arte 1',
      role: 'diseno',
    },
  },
  {
    username: 'arte2',
    password: 'Hid@s0l-Arte2-2025',
    user: {
      id: 'arte2-001',
      email: 'arte2@hidasol.com',
      name: 'Arte 2',
      role: 'diseno',
    },
  },
  {
    username: 'arte3',
    password: 'Hid@s0l-Arte3-2025',
    user: {
      id: 'arte3-001',
      email: 'arte3@hidasol.com',
      name: 'Arte 3',
      role: 'diseno',
    },
  },
  {
    username: 'arte4',
    password: 'Hid@s0l-Arte4-2025',
    user: {
      id: 'arte4-001',
      email: 'arte4@hidasol.com',
      name: 'Arte 4',
      role: 'diseno',
    },
  },
